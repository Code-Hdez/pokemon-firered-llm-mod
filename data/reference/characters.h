/*  
    Information and memory addresses extracted from the official decompilation project:
    pret/pokefirered — https://github.com/pret/pokefirered
    
    Note: At the time of this project, no license is declared in the repository;
    it retains existing copyright notices, and permissions should be verified before redistribution.
*/
